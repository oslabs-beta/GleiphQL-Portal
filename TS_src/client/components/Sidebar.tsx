...
import { Endpoint, PartialStore } from '../../types';
...
const Sidebar: FC = () : ReactElement => {
  ...
  return (
    <nav
      id='sidenav-8'
      className='opacity-70 sm:opacity-100 left-0 z-[1035] h-full w-60 -translate-x-full overflow-hidden bg-white shadow-[0_4px_12px_0_rgba(0,0,0,0.07),_0_2px_4px_rgba(0,0,0,0.05)] data-[te-sidenav-hidden="false"]:translate-x-0 dark:bg-zinc-800'
    ...
    >
      <ul
        className='relative m-0 list-none px-[0.2rem] pb-12 mt-2 pr-8'
      ...
      >
        ...
        >
          ...
          <ul
            className='!visible relative m-0 hidden list-none p-0 pl-2 data-[te-collapse-show]:block'
