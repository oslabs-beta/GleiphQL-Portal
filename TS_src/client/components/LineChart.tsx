    ...
    <section className='flex flex-col place-items-center'>
      {chartDataType === 'Requests'? (
        <p className='flex flex-row bg-blue-950 text-white rounded-md overflow-hidden m-4'>
          {chartTimeInterval === 'Last 24 Hours'? (
            <button className='p-2 border border-blue-950 border-r-black bg-blue-900' onClick={() : void =>setChartTime('Last 24 Hours')}>Last 24 Hours</button>
          ) : (
          ...
          {chartTimeInterval === 'Last 7 Days'? (
            <button className='p-2 border border-blue-950 border-r-black bg-blue-900' onClick={() : void =>setChartTime('Last 7 Days')}>Last 7 Days</button>
          ) : (
          ...
          {chartTimeInterval === 'Last 30 Days'? (
            <button className='p-2 border border-blue-950 bg-blue-900' onClick={() : void =>setChartTime('Last 30 Days')}>Last 30 Days</button>
          ) : (
        ...
        <p className='flex flex-row bg-blue-950 text-white rounded-md overflow-hidden m-4'>
          {chartTimeInterval === 'Last 10 Requests'? (
            <button className='p-2 border border-blue-950 border-r-black bg-blue-900' onClick={() : void =>setChartTime('Last 10 Requests')}>Last 10 Requests</button>
          ) : (
          ...
          {chartTimeInterval === 'Last 30 Requests'? (
            <button className='p-2 border border-blue-950 border-r-black bg-blue-900' onClick={() : void =>setChartTime('Last 30 Requests')}>Last 30 Requests</button>
          ) : (
          ...
          {chartTimeInterval === 'Last 100 Requests'? (
            <button className='p-2 border border-blue-950 bg-blue-900' onClick={() : void => setChartTime('Last 100 Requests')}>Last 100 Requests</button>
          ) : (
