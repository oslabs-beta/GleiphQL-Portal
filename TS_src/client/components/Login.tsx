  ...
  return (
    <div className='relative border-4 border-neutral-800 bg-stone-100 w-[450px] h-[520px] max-w-[450px]  mx-auto p-8 px-8 rounded-lg'>
      ...
      <form className='w-full h-full flex flex-col justify-evenly' onSubmit={handleSubmit}>
        ...
        <button data-cy='login-submit' className='w-10/12 my-3 mx-5 py-2 bg-sky-900 shadow-lg shadow-sky-500/50 hover:shadow-sky-500/40 hover:bg-sky-600 text-white font-semibold rounded-lg border border-transparent border-black cursor-pointer'>CONTINUE</button>
